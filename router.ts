...
export default class Router {
    ...
    public static findMatchingStaticRoute(requestedPath: string, staticRoutes: StaticRoute[]) {
        return staticRoutes.find(staticRoute => requestedPath.startsWith(staticRoute.path));
    }
}